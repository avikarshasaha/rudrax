utils.selectNamespace("utils.format", function(format) {
    ...
    format.set("date", function(value, options) {
        if (!options || !options.dateFormat) {
            ...
            if (utils.date[options.dateFormat])
                return utils.date[options.dateFormat](value, options.arg1);
        }
    }, function(i) {
        var o = new format.defMap();
        if (isSet(i.iVal)) {
    ...
    format.set("percent", function(value, options) {
        ...
        if (options) {
            options.dVal = obj.dVal;
            options.iVal = obj.iVal
        }
        ;
        return options.dVal;
    }, function(i) {
            ...
            if (isSet(i.minValueExpr)) {
                if (eval((o.iVal - 0) + "" + i.minValueExpr)) {
                    if (i.minValueExpr.indexOf('=') > -1) {
                        ...
                        var reason = "ui.error.incorrect" + i.fieldType + "InputValueLesThan$1:" + i.minValue;
                    o.isValid = false;
                    o.reason = reason;
                }
    ...
    format.set("amount", function(value, options) {
        ...
        if (options) {
            options.dVal = obj.dVal, options.iVal = obj.iVal
        }
        ;
        return options.dVal;
    }, function(i) {
    ...
    format.isDELTA = function(_Val) {
        if ((/^[aA][tT][mM][sSfF]{0,1}$/).test('' + _Val))
            return 'ATM';
        else if ((/^[1-9][0-9]*[dD]$/).test('' + _Val))
            return 'D'
        else
            return false;
    }
    ...
    format.set("number", function(value, options) {
        ...
        if (o.isValid) {
            if (isSet(i.minValue) && ((i.iVal - 0) < (i.minValue - 0))) {
